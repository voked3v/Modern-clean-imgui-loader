...
//#endif
    ...
    IMGUI_API bool          InjectButton(const char* id_label, const char* label, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
    IMGUI_API bool          ArrowButtonEx(const char* str_id, ImGuiDir dir, ImVec2 size_arg, ImGuiButtonFlags flags = 0);
    IMGUI_API bool          ImageButtonEx(ImGuiID id, ImTextureID texture_id, const ImVec2& size, const ImVec2& size_rect, const ImVec2& uv0, const ImVec2& uv1, const ImVec4& bg_col, const ImVec4& tint_col);

    IMGUI_API void          StatusClient(ImTextureID texture_id, const ImVec2& size, const ImVec2& size_rect, const char* game, bool undetected, const char* version, const char* update_date = "1.1.2023", const char* price = "0$");

    IMGUI_API void          SupportList(ImTextureID texture_id, const ImVec2& size, const ImVec2& size_rect, const char* name, ImU32 name_color, const char* status, ImU32 status_color);
    IMGUI_API void          InjectProduct(ImTextureID texture_id, const ImVec2& size, const ImVec2& size_rect, const char* name_product, ImU32 product_color, const char* active_until, ImU32 until_color);
