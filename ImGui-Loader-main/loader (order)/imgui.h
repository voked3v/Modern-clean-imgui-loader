...
namespace ImGui
{
    ...
    IMGUI_API void          BeginGroupP(const ImVec2& pos);
    IMGUI_API void          EndGroupP();
    ...
    IMGUI_API bool          CButton(const char* label, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
    IMGUI_API bool          SubTabs(bool selected, const char* label, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
    IMGUI_API bool          Tabs(bool selected, const char* ico_label, const ImVec2& size_arg = ImVec2(0, 0), ImGuiButtonFlags flags = 0);
    ...
    IMGUI_API bool          ImageButton(const char* str_id, ImTextureID user_texture_id, const ImVec2& size, const ImVec2& size_rect, const ImVec2& uv0, const ImVec2& uv1, const ImVec4& bg_col, const ImVec4& tint_col);

    IMGUI_API bool          ImageButton(ImTextureID user_texture_id, const ImVec2& size, const ImVec2& size_rect, const ImVec2& uv0, const ImVec2& uv1, int frame_padding, const ImVec4& bg_col, const ImVec4& tint_col);
